...
class CurrencyRepository @Inject constructor(private val apiHelper: ApiHelper) {
    suspend fun convert(toCurrency: String, fromCurrency: String, amount: String):ApiResult<ConvertResponse> =
        withContext(Dispatchers.IO) {
            try {
                ...
                val response: Response<ConvertResponse> = apiHelper.convert(toCurrency,fromCurrency,amount)
